...
<div id="my-datatable">
  <svg style='display:none;'>
    <defs>
    <path id="my-datatable_arrow_asc" preserveAspectRatio="xMinYMin meet" fill="none" stroke="var(--my-datatable-svg-stroke)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M10 17V4m-7 6l7-7 7 7"/>
    <path id="my-datatable_arrow_desc" style="transform:translate(20px,20px) rotate(180deg);" preserveAspectRatio="xMinYMin meet" fill="none" stroke="var(--my-datatable-svg-stroke)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M10 17V4m-7 6l7-7 7 7"/>
